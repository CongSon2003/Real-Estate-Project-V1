    ...
    <div className="bg-white md:h-[1100px] lg:h-[830px] flex justify-center">
      <div className="h-full flex-col flex justify-end items-center py-10 w-primary px-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mt-5">
          <div className="relative group overflow-hidden rounded-xl h-[245px] ">
            <Image
              alt=""
              src={"/house-1.jpg"}
              width={400}
              height={241}
              className="w-full h-full group-hover:scale-110 object-cover ease-linear transition duration-200 delay-100"
            />
          ...
          <div className="relative group overflow-hidden rounded-xl h-[245px] ">
            <Image
              ...
              width={400}
              height={241}
              className="w-full h-full object-cover group-hover:scale-110 ease-linear transition duration-200 delay-100"
            />
            <div className="absolute bg-gradient-to-t from-black/20 inset-0 to-transparent p-4 flex flex-col justify-between text-white">
              <div>
                <h3 className="text-lg font-bold">Washington</h3>
          ...
          <div className="relative group rounded-xl overflow-hidden h-[245px]">
            <Image
              alt=""
              src={"/house-3.jpg"}
              width={400}
          ...
          <div className="relative group rounded-xl overflow-hidden sm:col-span-1 lg:col-span-2 h-[245px]">
            <Image
              alt=""
              src={"/house-5.jpg"}
              width={400}
              height={241}
              className="w-full h-full object-cover object-bottom group-hover:scale-110 ease-linear transition duration-200 delay-100"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent p-4 flex flex-col justify-between text-white">
              <div>
                <h3 className="text-lg font-bold">Washington</h3>
...
export default ProperticeAreaStart;
